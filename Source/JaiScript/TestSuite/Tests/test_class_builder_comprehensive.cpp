...
JAI_TEST(method_chaining_support) {
    ...
    makeClassBuilder<Builder>(engine, "Builder")
        ...
        .method("getName", &Builder::getName)
...
JAI_TEST(multiple_classes) {
    ...
    makeClassBuilder<SimplePoint>(engine, "SimplePoint")
        .constructor<float, float>()
...
JAI_TEST(constructor_overloading_comprehensive) {
    ...
    makeClassBuilder<NumberBox>(engine, "NumberBox")
        .constructor<>()                           // Default constructor
        .constructor<int>()                        // Value constructor
        .constructor<int, float>()                 // Value + multiplier constructor
    ...
    Value result1 = engine.execute(script1);
    ...
    Value result2 = engine.execute(script2);
    ...
    Value result3 = engine.execute(script3);
