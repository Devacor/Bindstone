...
JAI_TEST(register_spaceship_only_class) {
    ...
    makeClassBuilder<SpaceshipOnly>(engine, "SpaceshipOnly")
        .constructor<>()
        .constructor<int>()
...
JAI_TEST(verify_comparison_operators_generated) {
    ...
    makeClassBuilder<ComparisonVerifier>(engine, "ComparisonVerifier")
        .constructor<>()
        .constructor<int>()
...
JAI_TEST(class_builder_constructor_fix) {
    // Test that the ClassBuilder constructor lambda capture fix works correctly
    Engine engine;
    
    makeClassBuilder<SpaceshipOnly>(engine, "TestClass")
        .constructor<>()
        .constructor<int>()
        .build();
