...
namespace jai::vm {
    ...
    private:
        ...
        // Fuses a whole-RHS trailing fused-binary/load/const with its identifier compound store
        void emit_compound_store(uint32_t symbol_index, uint32_t slot, uint32_t kind_flags, const expression* rhs);
