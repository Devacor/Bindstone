...
namespace MV {
	void hookButton(chaiscript::ChaiScript& a_script, MV::TapDevice& a_tapDevice) {
	...
	void hookClickable(chaiscript::ChaiScript &a_script, TapDevice &a_tapDevice) {
	...
	void hookComponent(chaiscript::ChaiScript &a_script) {
	...
	void hookDrawable(chaiscript::ChaiScript &a_script) {
	...
	void hookEmitter(chaiscript::ChaiScript &a_script) {
	...
	void hookNode(chaiscript::ChaiScript &a_script) {
	...
	void hookParallax(chaiscript::ChaiScript &a_script) {
	...
	void hookPath(chaiscript::ChaiScript &a_script) {
	...
	void hookAnimationEventData(chaiscript::ChaiScript &a_script) {
	...
	void hookAnimationTrack(chaiscript::ChaiScript &a_script) {
		...
		hookAnimationEventData(a_script);
	}

	void hookSpine(chaiscript::ChaiScript &a_script) {
	...
	void hookFileBundle(chaiscript::ChaiScript &a_script) {
	...
	void hookSprite(chaiscript::ChaiScript &a_script) {
	...
	void hookText(chaiscript::ChaiScript &a_script) {
