...
namespace M2Rend {
   ...
   public:
      ...
      void setSortDepth(double a_newDepth){alertParent("NeedsSort");depthOverride = true; overrideDepthValue = a_newDepth;}
      void unsetSortDepth(){alertParent("NeedsSort");depthOverride = false;}
   ...
   class DrawLine : public DrawShape{
      ...
      DrawLine(Draw2D *a_renderer):DrawShape(a_renderer){
         Pnt.resize(2);
      }
      ...
      void setEnds(const Point &a_startPoint, const Point &a_endPoint);
   ...
   public:
      ...
      void setSizeAndLocation(const Point &a_TopLeft, double a_width, double a_height);
   ...
   public:
      ...
      virtual bool remove(std::shared_ptr<DrawShape> a_childItem, bool a_deleteOnRemove = true);
      virtual bool remove(const std::string &a_childId, bool a_deleteOnRemove = true);
